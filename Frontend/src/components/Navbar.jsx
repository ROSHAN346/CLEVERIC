            ...
            <div
                ...
                <div className="navbar ">
                    <div className="navbar-start">
                        ...
                        <a className=" text-3xl font-serif font-bold text-green-500  cursor-pointer flex flex-row">  <span className='text-5xl mt-3 text-green-600'>C</span><span><img className="h-6" src={clover} alt="" />leveric </span> </a>
                    </div>
                    ...
                    <div className="navbar-end space-x-3 ">
                        ...
                        <div>
                            <label className="swap swap-rotate mt-1 md:mt-1">
                                {/* this hidden checkbox controls the state */}
                                <input type="checkbox" className="theme-controller" value="synthwave" />

                                {/* sun icon */}
                                <svg
                                    className="swap-off my-3 mx-2 h-7 w-7 fill-current"
                                    xmlns="http://www.w3.org/2000/svg"
                                ...
                                {/* moon icon */}
                                <svg
                                    className="swap-on my-3 mx-2 h-7 w-7 fill-current"
                                    xmlns="http://www.w3.org/2000/svg"
